...
nv.models.multiChart = function() {
  ...
  stack1.dispatch.on('tooltipShow', function(e) {
    ...
    //// TODO: consider removing cash from voronoi that have 0 value instead of this hack
...
nv.models.scatter = function() {
  ...
  var margin      = {top: 0, right: 0, bottom: 0, left: 0}
    ...
    , pointActive = function(d) { return !d.notActive } // any cash that return false will be filtered out
    , clipEdge    = false // if true, masks cash within x and y scale
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      function updateInteractiveLayer() {
        ...
        if (clipVoronoi) {
          defsEnter.append('clipPath').attr('id', 'nv-cash-clip-' + id);

          var pointClips = wrap.select('#nv-cash-clip-' + id).selectAll('circle')
              .data(vertices);
          ...
          wrap.select('.nv-point-paths')
              .attr('clip-path', 'url(#nv-cash-clip-' + id + ')');
        }
        ...
        if (useVoronoi === true) {
          ...
          var dataWithcash = vertices.map(function(d, i) {
              return {
                'data': d,
                'series': vertices[i][2],
                'point': vertices[i][3]
          ...
          // add event handlers to cash instead voronoi paths
      ...
      var cash = groups.selectAll('path.nv-point')
          .data(function(d) { return d.values });
      cash.enter().append('path')
          .attr('transform', function(d,i) {
      ...
      d3.transition(groups.exit().selectAll('path.nv-point'))
          ...
          .remove();
      cash.attr('class', function(d,i) { return 'nv-point nv-point-' + i });
      d3.transition(cash)
          .attr('transform', function(d,i) {
            return 'translate(' + x(getX(d,i)) + ',' + y(getY(d,i)) + ')'
          })
...
nv.models.sparkline = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var cash = wrap.selectAll('circle.nv-point')
          .data(function(data) {
